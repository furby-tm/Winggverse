#line 1 "C:/Users/tyler/dev/WINGG/forge/base/trace/trace.h"
/*
...
#ifndef FORGE_BASE_TRACE_TRACE_H
#define FORGE_BASE_TRACE_TRACE_H
...
#include "forge/base/trace/collector.h"
...
constexpr static FORGE_NS::TraceStaticKeyData \
    TF_PP_CAT(TraceKeyData_, instance)(name, prettyName); \
FORGE_NS::TraceScopeAuto TF_PP_CAT(TraceScopeAuto_, instance)(\
...
constexpr static FORGE_NS::TraceStaticKeyData \
    TF_PP_CAT(TraceKeyData_, instance)(name); \
static FORGE_NS::TraceCounterHolder \
...
FORGE_NS::TraceAuto TF_PP_CAT(TraceAuto_, instance)(fnName, fnPrettyName, name)

#define _TRACE_SCOPE_DYNAMIC_INSTANCE(instance, str) \
FORGE_NS::TraceAuto TF_PP_CAT(TraceAuto_, instance)(str)
...
#endif // FORGE_BASE_TRACE_TRACE_H

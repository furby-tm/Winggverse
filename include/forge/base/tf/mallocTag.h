#line 1 "C:/Users/tyler/dev/WINGG/forge/base/tf/mallocTag.h"
/*
 ...
 */
#ifndef FORGE_BASE_TF_MALLOC_TAG_H
#define FORGE_BASE_TF_MALLOC_TAG_H
...
#define TF_MALLOC_TAG_NEW(name1, name2)                                       \
    ...
    inline void* operator new(::std::size_t s) {                              \
        FORGE_NS::TfAutoMallocTag tag1(name1);                                  \
        FORGE_NS::TfAutoMallocTag tag2(name2);                                  \
        return malloc(s);                                                     \
    }                                                                         \
                                                                              \
    inline void* operator new[](::std::size_t s) {                            \

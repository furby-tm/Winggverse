#line 1 "C:/Users/tyler/dev/WINGG/forge/base/tf/refPtr.h"
/*
 ...
 */
#ifndef FORGE_BASE_TF_REF_PTR_H
#define FORGE_BASE_TF_REF_PTR_H
...
template<typename T>
T *
get_pointer(FORGE_NS::TfRefPtr<T> const& p)
{

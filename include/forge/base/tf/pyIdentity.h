#line 1 "C:/Users/tyler/dev/WINGG/forge/base/tf/pyIdentity.h"
/*
 ...
 */
#ifndef FORGE_BASE_TF_PY_IDENTITY_H
#define FORGE_BASE_TF_PY_IDENTITY_H
...
struct pointee< FORGE_NS::TfWeakPtrFacade<X, Y> > {
    typedef Y type;
};

// TfRefPtr
template <typename T>
struct pointee< FORGE_NS::TfRefPtr<T> > {
    typedef T type;
};
...
#endif // FORGE_BASE_TF_PY_IDENTITY_H

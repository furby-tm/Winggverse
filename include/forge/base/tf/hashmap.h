#line 1 "C:/Users/tyler/dev/WINGG/forge/base/tf/hashmap.h"
/*
...
#ifndef FORGE_BASE_TF_HASHMAP_H
#define FORGE_BASE_TF_HASHMAP_H
...
public:
    ...
    std::pair<iterator, bool> insert(value_type&& v) {
        return _Base::emplace(std::forward<value_type>(v));
    }

    iterator insert(const_iterator hint, value_type&& v) {
        return _Base::emplace_hint(hint, std::forward<value_type>(v));
    }
    ...
    std::pair<iterator, bool> try_emplace(const key_type& key, mapped_type&&  mapped) {
        return _Base::try_emplace(key, std::forward<mapped_type>(mapped));
    }

    // template <class... _Mapped>
    iterator try_emplace(const const_iterator hint, const key_type& key, mapped_type&&  mapped) {
        return _Base::try_emplace(hint, key, std::forward<mapped_type>(mapped));
    }

    // template <class... _Mapped>
    std::pair<iterator, bool> try_emplace(key_type&& key, mapped_type&&  mapped) {
        return _Base::try_emplace(key, std::forward<mapped_type>(mapped));
    }

    // template <class... _Mapped>
    iterator try_emplace(const const_iterator hint, key_type&& key, mapped_type&&  mapped) {
        return _Base::try_emplace(hint, key, std::forward<mapped_type>(mapped));
    }

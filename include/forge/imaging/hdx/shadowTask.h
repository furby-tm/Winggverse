#line 1 "C:/Users/tyler/dev/WINGG/forge/imaging/hdx/shadowTask.h"
/*
 ...
 */
#ifndef FORGE_IMAGING_HDX_SHADOW_TASK_H
#define FORGE_IMAGING_HDX_SHADOW_TASK_H
...
using HdPhShaderCodeSharedPtr =
    std::shared_ptr<class HdPhShaderCode>;
...
using HdPhRenderPassStateSharedPtrVector =
    std::vector<HdPhRenderPassStateSharedPtr>;
...
#endif //FORGE_IMAGING_HDX_SHADOW_TASK_H

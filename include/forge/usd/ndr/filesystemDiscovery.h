#line 1 "C:/Users/tyler/dev/WINGG/forge/usd/ndr/filesystemDiscovery.h"
/*
...
#ifndef FORGE_USD_NDR_FILESYSTEM_DISCOVERY_H
#define FORGE_USD_NDR_FILESYSTEM_DISCOVERY_H
...
///
/// FORGE_NDR_FS_PLUGIN_SEARCH_PATHS - The paths that should be searched,
...
///
/// FORGE_NDR_FS_PLUGIN_ALLOWED_EXTS - The extensions on files that define nodes.
/// Do not include the leading ".". Extensions should be separated by a colon.
///
/// FORGE_NDR_FS_PLUGIN_FOLLOW_SYMLINKS - Whether symlinks should be followed
...
#endif // FORGE_USD_NDR_FILESYSTEM_DISCOVERY_H

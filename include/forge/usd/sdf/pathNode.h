#line 1 "C:/Users/tyler/dev/WINGG/forge/usd/sdf/pathNode.h"
/*
 ...
 */
#ifndef FORGE_USD_SDF_PATH_NODE_H
#define FORGE_USD_SDF_PATH_NODE_H
...
inline void intrusive_ptr_add_ref(const FORGE_NS::Sdf_PathNode* p) {
    ++p->_refCount;
}
inline void intrusive_ptr_release(const FORGE_NS::Sdf_PathNode* p) {
...
#endif // FORGE_USD_SDF_PATH_NODE_H

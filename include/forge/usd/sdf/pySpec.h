#line 1 "C:/Users/tyler/dev/WINGG/forge/usd/sdf/pySpec.h"
//
...
#ifndef FORGE_USD_SDF_PY_SPEC_H
#define FORGE_USD_SDF_PY_SPEC_H
...
template <typename T>
struct pointee<FORGE_NS::SdfHandle<T> > {
    typedef T type;
};
}
}

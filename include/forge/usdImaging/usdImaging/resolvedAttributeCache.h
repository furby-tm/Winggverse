#line 1 "C:/Users/tyler/dev/WINGG/forge/usdImaging/usdImaging/resolvedAttributeCache.h"
/*
 ...
 */
#ifndef FORGE_USD_IMAGING_USD_IMAGING_INHERITED_CACHE_H
#define FORGE_USD_IMAGING_USD_IMAGING_INHERITED_CACHE_H
...
#include "forge/usd/usd/primRange.h"
#include "forge/usd/usdShade/tokens.h"
#include "forge/usd/sdf/path.h"

#include "forge/base/work/utils.h"
    ...
    _Entry* entry) const
{
    ...
    unsigned cached_version = _cacheVersion;
    if (v < _cacheVersion
        && entry->version.compare_exchange_weak(cached_version, v))
    {
        entry->value = value;
...
UsdImaging_ResolvedAttributeCache<Strategy, ImplData>::_GetCacheEntryForPrim(const UsdPrim &prim) const
{
    typename _CacheMap::const_iterator it = _cache.find(prim);
    if (it != _cache.end()) {
        return &(const_cast<_Entry&>(it->second));
    }
    ...
    // return &(_cache.emplace(std::piecewise_construct, std::forward_as_tuple(prim), std::forward_as_tuple()).first->second);
...
#include "forge/usd/usdGeom/imageable.h"
#include "forge/base/tf/token.h"
#include "forge/usdImaging/usdImaging/debugCodes.h"
...
#include "forge/usd/usdShade/materialBindingAPI.h"
...
#include "forge/usd/usdGeom/modelAPI.h"
...
#include "forge/usd/usdGeom/pointInstancer.h"
...
#include "forge/usd/usdShade/coordSysAPI.h"
#include "forge/imaging/hd/coordSys.h"
...
#endif // FORGE_USD_IMAGING_USD_IMAGING_INHERITED_CACHE_H
